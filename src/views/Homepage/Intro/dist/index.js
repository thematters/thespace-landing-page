...
var Intro = function () {
  return React.createElement(
    "section",
    { className: styles_module_sass_1["default"].intro },
    React.createElement(
      "div",
      { className: "container" },
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { className: styles_module_sass_1["default"].illu },
            React.createElement(
              "figure",
              { className: "text-end" },
              React.createElement(image_1["default"], {
                className: "img-fluid",
                src: intro_illu_svg_1["default"],
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { className: styles_module_sass_1["default"].divider },
            React.createElement(
              "figure",
              null,
              React.createElement(image_1["default"], {
                className: "img-fluid",
                src: intro_divider_svg_1["default"],
                alt: "Intro Divider",
              })
            )
          ),
          React.createElement(
            "div",
            { className: styles_module_sass_1["default"].title },
            React.createElement(
              "h1",
              { className: styles_module_sass_1["default"].bar },
              "The Space: ",
          ...
          React.createElement(
            "div",
            { className: styles_module_sass_1["default"].text },
            React.createElement(
              "p",
              null,
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { className: styles_module_sass_1["default"].buttons + " buttons" },
            React.createElement(
              "a",
              {
                className: "btn fill",
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { className: styles_module_sass_1["default"].tips },
            React.createElement("span", {
              className: styles_module_sass_1["default"].icon,
            })
          )
        )
      )
