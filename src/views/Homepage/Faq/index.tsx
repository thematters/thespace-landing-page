        ...
        <div className={styles.content}>
          ...
          <details>
            ...
            <div className={styles.text}>
              ...
              <ul>
                <li>
                  <b>Initial Airdrop (2%):</b> to those who participated in test
                  launches of The Space and contributed to the Matters Lab
                  community
                </li>
                <li>
                ...
                <li>
                  <b>Early Stakeholders (8.74%):</b> to stakeholders who can
                  contribute to The Space's growth and development in the first
                  year
                </li>
                <li>
                  <b>Community Fund (66.26%):</b> to members of the SpaceDAO
                </li>
                <li>
                  <b>Liquidity Pool (5%):</b> available to the public on UniSwap
                </li>
                <li>
