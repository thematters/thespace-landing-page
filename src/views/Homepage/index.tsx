        ...
        <div className="col-md-5 col-xl-4">
          ...
          <div className={styles.text}>
            <p>
              ...
              and color pixels. Pixels are tokenized as ERC721 tokens and traded
              under Harberger Tax, while owners of pixels receive Universal
              Basic Income(UBI). In the Future, The administration of The Space
              will be transfered to SpaceDAO, a decentralized autonomous
              organization formed by all $SPACE token holders.
            </p>
          </div>
...
const SectionSubscribe: React.FC = () => (
      ...
      <div className={styles.content}>
        ...
        <div className={styles.feature}>
          ...
          <div className={styles.text}>
            ...
            <p>
              The Space is governed by Harberger Tax and Universal Basic Income
              (UBI) to decide the flow of pixels and the distribution of
              capitals, so that the public resource can be efficiently utilized.
            </p>
          </div>
        </div>
        <div className={styles.feature}>
          ...
          <div className={styles.text}>
            ...
            <p>
              ...
              meaning that The Space will never be shut down by any authorities,
              and all works created will be accessible forever.
            </p>
          </div>
        </div>
      </div>
...
const SectionFollowUs: React.FC = () => (
