        ...
        <section className={styles.social_media}>
          <div className="container">
            <div className={`${styles.title} d-flex justify-content-between align-items-center`}>
              ...
              <div className="buttons"><a className="btn fill" href="https://twitter.com/thespace2022" target="_blank">View More</a></div>
            </div>
          ...
          <div className="container">  
            <div className="row align-items-center">
              <div className="col-md-6">
                ...
                <div className={styles.text}>
                  <p>Matters is a writing community based on decentralized technologies, with open-sourced codebases and self-governed creators. The Space developer community is based on the same principle, with bounty programs that reward developers' contribution and creativity.</p>
                </div>
                <div className={`${styles.buttons} buttons`}>
                  <a className="btn fill" href="https://github.com/thematters/developer-resource" target="_blank">GitHub</a>
                </div>
              </div>
              <div className="col-md-6">
                <div className={styles.illu}>
                  <figure className="text-end"><img className="img-fluid" src="/img/developer-illu.svg"/></figure>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            ...
            <div className={styles.content}>
              <details>
                ...
                <div className={styles.text}>
                  <p>NFT stands for "non-fungible token". It is a special and unique digital item that users can buy, own, and trade.</p>
                  <p>Logbook 2.0 is generated based on ERC-721 and issued on Polygon. As a new digital writing method, NFT conforms to the laws of Matterverse. We are independent and protect creators’ rights, while connecting with each other in many different ways</p>
                </div>
              </details>
              <details>
